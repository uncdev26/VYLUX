...
-- Creates the 'cms' schema and all CMS tables inside ParadeDB
-- Run against: vylux-db (ParadeDB PostgreSQL 17)
...
CREATE INDEX idx_design_components_schema ON cms.design_components USING GIN(schema);
CREATE INDEX idx_design_components_styles ON cms.design_components USING GIN(styles);
...
CREATE INDEX idx_design_themes_tokens ON cms.design_themes USING GIN(tokens);
...
CREATE INDEX idx_posts_metadata ON cms.posts USING GIN(metadata);
...
CREATE INDEX idx_pages_content ON cms.pages USING GIN(content);
CREATE INDEX idx_pages_seo ON cms.pages USING GIN(seo);
...
CREATE INDEX idx_media_metadata ON cms.media USING GIN(metadata);
...
CREATE INDEX idx_seo_configs_structured_data ON cms.seo_configs USING GIN(structured_data);
...
CREATE INDEX idx_forms_fields ON cms.forms USING GIN(fields);
...
CREATE INDEX idx_submissions_data ON cms.submissions USING GIN(data);
...
CREATE INDEX idx_header_configs_config ON cms.header_configs USING GIN(config);
...
CREATE INDEX idx_footer_configs_config ON cms.footer_configs USING GIN(config);
...
CREATE INDEX idx_menu_items_page ON cms.menu_items(page_id);
CREATE INDEX idx_menu_items_config ON cms.menu_items USING GIN(config);
