-- VYLUX CMS Schema (reference)
-- NOTE: This file is the original design reference. The actual migration is at
-- packages/database/migrations/001_cms_schema.sql (runs against the `cms` schema
-- in LobeHub's ParadeDB instance). No separate Supabase database needed.
--
...
CREATE TABLE posts (
    ...
    author_id UUID,          -- no FK: references public.users by UUID in app layer
...
-- =============================================================================
-- Security: MCP tools run internally (no public API), so RLS is not needed.
-- Access control is handled at the application layer by LobeHub's auth.
-- =============================================================================
